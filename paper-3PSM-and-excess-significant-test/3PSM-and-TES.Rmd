...
For instance, an analyst might prefer to use the fixed effect estimator $\hat\mu_F$ for the average effect size because it is less biased than the random effects estimator under selective publication [cf. @henmi2010ConfidenceIntervalsRandom; @stanley2015NeitherFixedRandom], along with the restricted maximum likelihood estimator for $\tau^2$ because it is less biased than the maximum likelihood estimator.
