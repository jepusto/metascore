...
$$
\begin{aligned}
\frac{\partial l}{\partial \boldsymbol\beta} &= \sum_{i=1}^k \mathbf{x}_i' \left(\frac{e_i}{\eta_i^2} - \frac{\partial A_i / \partial \mu_i}{A_i}\right) \\
...
\frac{\partial l}{\partial \omega_s} &= \frac{n_s}{\omega_s} - \sum_{i=1}^k \frac{B_{is}}{A_i}
\end{aligned}
$$
...
$$
\begin{aligned}
\frac{\partial l}{\partial \boldsymbol\beta} &= \sum_{i=1}^k \frac{\mathbf{x}_i' e_i}{\eta_i^2} \\
\frac{\partial l}{\partial \tau^2} &= \frac{1}{2}\sum_{i=1}^k \frac{e_i^2}{\eta_i^4} - \frac{1}{2}\sum_{i=1}^k \frac{1}{\eta_i^2} \\
\frac{\partial l}{\partial \omega_s} &= n_s - \sum_{i=1}^k B_{is}
\end{aligned}
$$
...
\frac{\partial^2 A_i}{\partial \tau^2 \partial \omega_s} &= - \sum_{i=1}^n \frac{\partial B_{is}}{\partial \tau^2}
\end{aligned}
$$
